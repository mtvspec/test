...
SELECT id, gender_name AS "genderName" FROM persons.d_genders ORDER BY id DESC;
...
INSERT INTO persons.d_genders (id, gender_name) VALUES ('M', 'Мужской') RETURNING id;
-- Вставить справочное значение 'Женский' - ok
INSERT INTO persons.d_genders (id, gender_name) VALUES ('F', 'Женский') RETURNING id;
