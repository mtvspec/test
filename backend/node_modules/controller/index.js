...
Controller.prototype.validate = function validate(data, type) {
  ...
  case 'personData': // TODO реализовать проверку на наличие букв (только латиница и кирилица)
    ...
    (data.iin.length === 12 && typeof data.iin === 'string' && /^\d{2}(0[1-9]|1[0-2])(0[1-9]|[1-2]\d|3[01])[0-6]\d{5}$/.test(data.iin)) ? res = true : res = false;
    ...
    (res === true && typeof data.genderID === 'number' && data.genderID === 1 || data.genderID === 2) ? res = true : res = false;
    if (data.middleName) {
