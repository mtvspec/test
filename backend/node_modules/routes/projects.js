...
/* RequestController */
ProjectsRouter
.use('/:id/results', require('./results.js'))
/* RequestService */
...
.post('/', function (request, response) {
  ...
  var project = {
    ...
    /* required length: 2 */
    projectFormalName: String(request.body.projectFormalName),
    /* required length: 1 - 300 */
    projectWorkName: String(request.body.projectWorkName),
    /* length: 1 - 500 */
    projectOfficialName: String(request.body.projectOfficialName),
    startDate: new Date(request.body.startDate),
    endDate: new Date(request.body.endDate),
    budget: Number(request.body.budget),
    /* length: 12 */
    managerID: String(request.body.managerID)
  };
  if (PGController.validate(project, 'projectData')) {
    PGService.performQueryWL(
      DBQueries.insertProjectQuery(project),
