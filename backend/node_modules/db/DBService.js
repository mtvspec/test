...
DBService.prototype.selectRecordP = function selectRecordP(query) {
  return new Promise(function (success, failure) {
    pg.connect(function (err, client, done) {
      if (err) {
        console.error('selectRecordsP:', err.message);
        failure({
          status: 500,
          message: err.message
        });
...
DBService.prototype.selectRecordsByIDP = function selectRecordsByIDP(query) {
  ...
  return new Promise(function (success, failure) {
    pg.connect(function (err, client, done) {
      if (err) {
        console.error('selectRecordsByIDP:', err.message);
        failure({
          status: 500,
          message: err.message
        });
...
DBService.prototype.selectRecordsWL = function selectRecordsWL(query, cb) {
  ...
  pg.connect(function (err, client, done) {
    if (err) {
      console.error('selectRecordsWL:', err.message);
      return cb(500, null);
    }
    client.query({
      text: query.text,
...
DBService.prototype.selectRecordWL = function selectRecordWL(query, cb) {
  ...
  pg.connect(function (err, client, done) {
    if (err) {
      console.error('selectRecordWL:', err.message);
      return cb(500, null);
    }
    client.query({
      text: query.text,
...
DBService.prototype.selectRecordsByIDWL = function selectRecordsByIDWL(query, cb) {
  ...
  pg.connect(function (err, client, done) {
    if (err) {
      console.error('selectRecordsByIDWL:', err.message);
      return cb(500, null);
    }
    client.query({
      text: query.text,
