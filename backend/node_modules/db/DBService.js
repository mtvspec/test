...
DBService.prototype.selectRecordsWithoutLogging = function selectRecordsWithoutLogging(query, cb) {
  if (!query.text) {
    return cb(400, null);
  }
  pg.connect(function (err, client, done) {
...
DBService.prototype.selectRecordWithoutLogging = function selectRecordWithoutLogging(query, cb) {
  if (!query.values.id) {
    return cb(400, null);
  }
  pg.connect(function (err, client, done) {
...
DBService.prototype.updateRecordWithoutLogging = function updateRecordWithoutLogging(query, cb) {
  if (query.iin) {
    query.id = query.iin;
  }
  console.log('updateRecord:\n', log);
...
DBService.prototype.deleteRecordWithoutLogging = function deleteRecordWithoutLogging(query, cb) {
  if (query.iin) {
    query.id = query.iin;
  }
  if (!query.id) {
...
DBService.prototype.performQuery = function performQuery(query, queryLog, queryFn, cb) {
  ...
  queryLog = DBUtils.formatLog(queryLog);
