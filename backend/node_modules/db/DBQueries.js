var DBQueries = {
  ...
  selectPersonQuery: function selectPersonQuery(person) {
    return {
      text: 'SELECT id, last_name AS "lastName", first_name AS "firstName", middle_name AS "middleName", dob, gender_id AS "genderID" FROM persons.e_persons WHERE is_deleted = \'N\' AND id = {id};',
      values: person
    }
  },
