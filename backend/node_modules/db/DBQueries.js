var DBQueries = {
  ...
  selectCompaniesQuery: function selectCompaniesQuery() {
    return {
      text: 'SELECT bin, company_name AS "companyName", is_deleted AS "isDeleted" FROM e_companies ORDER BY bin ASC'
    }
  },
  ...
  insertCompanyQueryLog: function insertCompanyQueryLog(companyLog) {
    // body...
  },
