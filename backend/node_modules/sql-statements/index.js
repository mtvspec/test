...
var SQLStatements = {
  ...
  'companies': {
    'ru': {
      'select companies count': 'SELECT count(*) FROM companies.e_companies;',
      'select companies': 'SELECT id, short_name AS "shortName", long_name AS "longName", full_name AS "fullName" FROM companies.e_companies ORDER BY id ASC;',
      ...
      'update company': 'UPDATE companies.e_companies SET short_name = $2, long_name = $3, full_name = $4 WHERE id = $1 RETURNING id;',
